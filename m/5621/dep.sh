...
export SWR_NAME="Lauren/Robin"
# Full name, may be used in intro
export SWR_FULL_NAME="Lauren/Robin"
# Descriptive title on introductions, a la Fire Emblem Heroes
export SWR_EPITHET="Part-Time Tactician"
...
export SWR_AGE="21 (1999.06.21)"
# YYYY-MM-DD birthday to add to PK
export SWR_PK_BIRTHDAY="06-21"
