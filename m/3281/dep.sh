...
export SWR_NAME="Mitsuha"
# Full name, may be used in intro
export SWR_FULL_NAME="Mitsuha Miyamizu"
# Descriptive title on introductions, a la Fire Emblem Heroes
export SWR_EPITHET="Thread of Fate"
...
export SWR_ROLE="fashion specialist, emotional helper"
# Age/birthday to display on intro. Appended to relative age if enabled
export SWR_AGE="17 (2003.03.28)"
# YYYY-MM-DD birthday to add to PK
export SWR_PK_BIRTHDAY="03-28"
...
export GRI_NAME="宮水三葉"
# Epithet to show on bars (new intros) (JPN)
export GRI_EPITHET="運命の糸"
# Description (preferably written by member)
export SWR_DESC="hi, i'm mitsuha! i work as a jeweler in tokyo, and am really excited to join the system... and, idk, i just love being in the city and everything!"
# Proxy used on PK.
export SWR_PROXY="mi/text"
# Source of avatar
export SWR_ASOURCE="misskiwi on pixiv"
# URL of avatar source (if available)
export SWR_AURL="https://www.pixiv.net/artworks/81930587"
# Source of portrait
export SWR_PSOURCE="official artwork (Makoto Shinkai / CoMix Wave Films)"
