...
export SWR_SOURCE="The Girl Who Leapt Through Time"
...
export SWR_ROLE="Japanese speaker (solely)"
...
export GRI_NAME="紺野真琴"
# Epithet to show on bars (new intros) (JPN)
export GRI_EPITHET="時をかける少女"
# Description (preferably written by member)
export SWR_DESC=""
# Proxy used on PK.
export SWR_PROXY="ma/text"
# Source of avatar
export SWR_ASOURCE="C-WAVE on pixiv"
# URL of avatar source (if available)
export SWR_AURL="https://www.pixiv.net/artworks/69846491"
# Source of portrait
export SWR_PSOURCE="official art (Mamoru Hosoda / MADHOUSE)"
