...
export SWR_NAME="🔧Ayaha"
# Full name, may be used in intro
export SWR_FULL_NAME="Ayaha Oribe"
# Descriptive title on introductions, a la Fire Emblem Heroes
export SWR_EPITHET="Fortuna Secretary"
