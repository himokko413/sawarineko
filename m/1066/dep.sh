...
export SWR_NAME="Eleonora"
# Full name, may be used in intro
export SWR_FULL_NAME="Eleonora Yumizuru"
# Descriptive title on introductions, a la Fire Emblem Heroes
export SWR_EPITHET="Hollywood Darling"
...
export SWR_SURL="https://fireemblem.fandom.com/wiki/Eleonora_Yumizuru"
...
export SWR_AGE="18 (2002.01.29)"
# YYYY-MM-DD birthday to add to PK
export SWR_PK_BIRTHDAY="01-29"
