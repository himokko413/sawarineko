...
export SWR_NAME="Tsubasa Oribe"
# Full name, may be used in intro
export SWR_FULL_NAME="Tsubasa Oribe"
# Descriptive title on introductions, a la Fire Emblem Heroes
export SWR_EPITHET="Sacred Idol"
...
# Proxy used on PK.
export SWR_PROXY="to/text"
# Source of avatar
export SWR_ASOURCE="trutsmn on pixiv"
# URL of avatar source (if available)
export SWR_AURL="https://www.pixiv.net/artworks/55199263"
# Source of portrait
export SWR_PSOURCE="official art by toi8 (ATLUS / INTELLIGENT SYSTEMS)"
