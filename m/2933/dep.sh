...
export SWR_TYPE="semi-verbal fictive"
# Source (meant for introjects but can also describe reason for formation)
export SWR_SOURCE="Fire Emblem Elibe"
...
export GRI_EPITHET="魔道の申し子"
# Description (preferably written by member)
export SWR_DESC=""
# Proxy used on PK.
export SWR_PROXY="ni/text"
# Source of avatar
export SWR_ASOURCE="Atanarix on DeviantArt"
# URL of avatar source (if available)
export SWR_AURL="https://www.deviantart.com/atanarix/art/Headpats-for-Nino-719766725"
# Source of portrait
