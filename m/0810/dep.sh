...
export SWR_NAME="Akari Shirakawa"
# Full name, may be used in intro
export SWR_FULL_NAME="Akari Shirakawa"
# Descriptive title on introductions, a la Fire Emblem Heroes
export SWR_EPITHET="Virtual Cuteness"
...
export SWR_SOURCE="Lucy P, Hina, and Tsubasa O"
