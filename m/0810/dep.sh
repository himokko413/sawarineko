...
export SWR_ROLE="literally a vtuber"
# Age/birthday to display on intro. Appended to relative age if enabled
export SWR_AGE="not applicable (05.08)"
# Birthday to add to PK
export SWR_PK_BIRTHDAY="05-08"
...
export GRI_NAME="好味赤林"
# Epithet to show on bars (new intros) (JPN)
export GRI_EPITHET="掌中の玉"
# Description (preferably written by member)
export SWR_DESC="A former deity in the Cornucopia. Banished after an attempt to expand her \"Ringo-nomics\" into a galactic empire. Frequently plays games, and despises Apple Inc. for making light of Ringo-nomics. Has a bright and peppy personality, though she sometimes gets exasperated over little things."
# Proxy used on PK.
export SWR_PROXY="as/text"
# Source of avatar
