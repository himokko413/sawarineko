...
export SWR_SOURCE="Weathering With You"
...
export SWR_AGE="17 (2002.08.22)"
# YYYY-MM-DD birthday to add to PK
export SWR_PK_BIRTHDAY="08-22"
...
export GRI_NAME="天野陽菜"
# Epithet to show on bars (new intros) (JPN)
export GRI_EPITHET="１００％の晴れ女"
# Description (preferably written by member)
export SWR_DESC="Hey there, I'm Hina. I'm chipper, yet straightforward. What I want to do is help people through tough times, and turn their rainy days into sunny days!"
# Proxy used on PK.
export SWR_PROXY="hi/text"
# Source of avatar
export SWR_ASOURCE="Melanie XD on pixiv"
# URL of avatar source (if available)
export SWR_AURL="https://www.pixiv.net/artworks/83597620"
# Source of portrait
export SWR_PSOURCE="official art (Makoto Shinkai / CoMix Wave Films)"
