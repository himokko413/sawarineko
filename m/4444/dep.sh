...
export SWR_TYPE="endogenic fictive"
# Source (meant for introjects but can also describe reason for formation)
export SWR_SOURCE="Nyan Neko Sugar Girls"
...
export SWR_DESC=""
# Proxy used on PK.
export SWR_PROXY="ra/text"
# Source of avatar
export SWR_ASOURCE="official artwork (SoapOpera46)"
# URL of avatar source (if available)
export SWR_AURL=""
# Source of portrait
export SWR_PSOURCE="official artwork (SoapOpera46)"
