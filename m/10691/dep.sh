...
export SWR_FULL_NAME="Tharja"
# Descriptive title on introductions, a la Fire Emblem Heroes
export SWR_EPITHET="Grim Technowiz"
...
export SWR_TYPE="illusory fictive"
...
export GRI_NAME="サーリャ"
# Epithet to show on bars (new intros) (JPN)
export GRI_EPITHET="物陰の闇使い"
# Description (preferably written by member)
export SWR_DESC=""
# Proxy used on PK.
export SWR_PROXY="tj/text"
# Source of avatar
export SWR_ASOURCE="official art (ATLUS / INTELLIGENT SYSTEMS)"
# URL of avatar source (if available)
export SWR_AURL=""
# Source of portrait
export SWR_PSOURCE="concept art by toi8"
