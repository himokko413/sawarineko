...
export SWR_SOURCE="GYARI Vocaloid"
...
export GRI_NAME="紲星あかり"
# Epithet to show on bars (new intros) (JPN)
export GRI_EPITHET="アカリがやってきたぞっ"
# Description (preferably written by member)
export SWR_DESC=""
# Proxy used on PK.
export SWR_PROXY="ak/text"
# Source of avatar
export SWR_ASOURCE="art by GYARI"
# URL of avatar source (if available)
export SWR_AURL="https://www.youtube.com/watch?v=tyneiz9FRMw"
# Source of portrait
export SWR_PSOURCE="art by GYARI"
# URL of portrait source (if available)
export SWR_PURL="https://www.youtube.com/watch?v=tyneiz9FRMw"
