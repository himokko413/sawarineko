...
export SWR_NAME="Itsuki"
# Full name, may be used in intro
export SWR_FULL_NAME="Itsuki Aoi"
# Descriptive title on introductions, a la Fire Emblem Heroes
export SWR_EPITHET="President of Another Fortuna"
...
export SWR_SURL="https://fireemblem.fandom.com/wiki/Itsuki_Aoi"
...
export SWR_AGE="19 (2001.07.30)"
# YYYY-MM-DD birthday to add to PK
export SWR_PK_BIRTHDAY="07-30"
