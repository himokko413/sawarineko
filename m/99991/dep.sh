...
export GRI_NAME="ソティス"
# Epithet to show on bars (new intros) (JPN)
export GRI_EPITHET="玉座の印刷少女"
# Description (preferably written by member)
export SWR_DESC=":so_this:"
# Proxy used on PK.
export SWR_PROXY="so/text"
# Source of avatar
export SWR_ASOURCE="official art (Nintendo / INTELLIGENT SYSTEMS)"
