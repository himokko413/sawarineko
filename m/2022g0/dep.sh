...
export SWR_SOURCE="Sword Art Online"
# Source explanation (character page for fictives, Blossom definition etc.)
export SWR_SURL="https://swordartonline.fandom.com/wiki/Konno_Yuuki"
...
export GRI_NAME="紺野木綿季"
# Epithet to show on bars (new intros) (JPN)
export GRI_EPITHET="絶剣"
# Description (preferably written by member)
export SWR_DESC=""
# Proxy used on PK.
export SWR_PROXY="zk/text"
# Source of avatar
export SWR_ASOURCE="official art (SAO LN volume 7)"
# URL of avatar source (if available)
export SWR_AURL=""
# Source of portrait
export SWR_PSOURCE="official CG (SAO: Hollow Fragment)"
